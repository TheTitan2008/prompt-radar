...
def _flat_run(item: dict[str, Any]) -> dict[str, Any]:
    ...
    return {
        ...
        "business_task_episode_id": item.get("business_task_episode_id"),
        "episode_confidence": item.get("episode_confidence"),
        "episode_value_counted": item.get("episode_value_counted"),
        "run_status": item["run_status"],
        "baseline_cluster_minutes_low": item.get("baseline_cluster_minutes_low"),
        "baseline_cluster_minutes_base": item.get("baseline_cluster_minutes_base"),
        "baseline_cluster_minutes_high": item.get("baseline_cluster_minutes_high"),
        "size_factor": item.get("size_factor"),
        "complexity_factor": item.get("complexity_factor"),
        "attachment_factor": item.get("attachment_factor"),
        "adjusted_manual_minutes_low": item.get("adjusted_manual_minutes_low"),
        "adjusted_manual_minutes_base": item.get("adjusted_manual_minutes_base"),
        "adjusted_manual_minutes_high": item.get("adjusted_manual_minutes_high"),
        "baseline_evidence_source": item.get("baseline_evidence_source"),
        "baseline_type": item.get("baseline_type"),
...
def _flat_cluster(item: dict[str, Any]) -> dict[str, Any]:
    ...
    return {
        ...
        "cluster_coherence": item.get("cluster_coherence"),
        "economic_homogeneity": item.get("economic_homogeneity"),
        "economic_passport_status": item.get("economic_passport_status"),
        "economic_passport_reason": item.get("economic_passport_reason"),
